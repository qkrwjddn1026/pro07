...
<head>
    ...
    <style type="text/css">
    	...
    	#footer { position : absolute;
				  bottom : 0; width: 100%; height: 53px; margin-bottom: -300px;}
    </style>
			      	...
			      	<tbody>
			      		<tr>
							...
							<c:if test="${not empty qid }">
								<p id="msg" style="padding-left:0.1rem">아이디 중복 체크후 수정하였습니다.</p>
							</c:if>
			      			</td>
			      		</tr>
			      		<tr>
		      			...
		      			<tr>
			      			...
			      			<td>
			      				...
			      				<input type="text" name="postcode" id="postcode" placeholder="우편번호 입력" maxlength="9" required style="margin-right: 85px;">
					...
					$.ajax({
						...
						success:function(result){
							...
							if(idChk==false){	//사용할 수 없는 아이디
								$("#idck").val("no");
								$("#msg").html("<strong style='text-align: left;'>기존에 사용되고 있는 아이디 입니다. 다시 입력하시기 바랍니다.</strong>");
								$("#id").focus();
							} else if(idChk==true){	//사용 가능한 아이디
								$("#idck").val("yes");
								$("#msg").html("<strong style='text-align: left;'>사용가능한 아이디 입니다.</strong>");
							} else if(idck==""){
