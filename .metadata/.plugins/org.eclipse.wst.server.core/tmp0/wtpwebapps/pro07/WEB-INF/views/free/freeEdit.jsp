			      	...
			      	<tbody>
			      		...
			      		<tr>
			      			<td colspan="2" style="float:left;">
			      				<input type="submit" class="hollow button" value="글 수정" >
			      				<a class="button hollow" href="${path1 }/free/list.do"><span>목록
		        	  	<i class="fi-list"></i></span></a>
			      			</td>
